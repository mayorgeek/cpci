...
<div>
    ...
    ">
        <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
            ...
            <div class="flex justify-center items-center h-full">
                <div>
                    <h2 class="font-normal text-6xl mb-4 text-white opacity-95">Get Involved</h2>
    ...
    {{-- Call To Action --}}
    <div class="flex flex-col items-center justify-center p-20 mt-10">
        <h3 class="text-[#504A4A] text-center font-light text-base uppercase">Next Step</h3>
        <h1 class="text-[#2B2929] text-center font-light text-4xl mt-6">We Gather Every Sunday</h1>
    ...
    {{-- Call to action 2 --}}
    <div class="mt-10 p-12 text-center relative overflow-hidden bg-no-repeat bg-cover shadow-xl h-[900px] w-full" style="
        background-image: url('{{ asset('images/mountain-background.jpg') }}');">
        <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed flex flex-col items-center p-20"
            ...
            <div class="p-12 text-center relative overflow-hidden bg-no-repeat bg-cover shadow-xl" style="
                ...
                <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed flex flex-col justify-center items-center"
                    ...
                    <h1 class="text-white text-center font-light text-4xl capitalize mt-3">We Gather Every Sunday</h1>
                </div>
            </div>


            {{-- Grid Section --}}
            <div class="grid grid-cols-3 gap-x-20 gap-y-20 text-left mt-24">
                <div>
