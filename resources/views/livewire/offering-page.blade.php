...
@section('title')
Offering - Christ Preachers Church International
@endsection
...
<div>
    ...
    <div class="bg-gray-100 px-8 py-20 lg:p-20 flex justify-center">
        <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
            <form wire:submit.prevent="offering">
                <h1 class="text-gray-900 text-xl text-center font-medium mb-10">Offering</h1>
