...
<div>
    ...
    ">
        <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
            ...
            <div class="flex justify-center items-center h-full">
                <div>
                    <h2 class="font-normal text-4xl lg:text-6xl mb-4 text-white opacity-95">Next Steps</h2>
                    <p class="lg:w-[748px] font-light text-xl text-white opacity-95 mb-10 mt-2">Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit.</p>
                    <div class="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6 items-center lg:justify-center">
                        ...
                        <a class="inline-block px-6 py-3 bg-white text-main font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-white hover:shadow-lg focus:bg-white focus:shadow-lg focus:outline-none focus:ring-0 active:bg-white active:shadow-lg transition duration-150 ease-in-out"
    ...
    <div class="px-6 py-20 lg:p-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-y-0 gap-x-0 mt-10 lg:mx-auto">
            {{-- Step 1 --}}
    ...
    {{-- Care & Prayer --}}
    <div class="flex flex-col items-center lg:flex-row lg:justify-center lg:space-x-16 mt-10 px-6 lg:p-20">
        {{-- Left Section --}}
        ...
        {{-- Right Section --}}
        <div class="w-[320px] mt-12 lg:mt-0">
    ...
    {{-- Serving --}}
    <div class="flex flex-col-reverse items-center lg:flex-row lg:justify-center lg:space-x-16 mt-10 px-6 lg:p-20">
        {{-- Left Section --}}
        <div class="w-[320px] mt-12">
            <div class="p-12 text-center relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-xl" style="
    ...
    <div class="p-20 my-16 flex flex-col items-center">
        ...
        <h1 class="text-[#2B2929] text-center font-light text-2xl lg:text-4xl capitalize mt-6">We Gather Every Sunday</h1>
